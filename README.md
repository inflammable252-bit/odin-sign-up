...
-Cleaner conventions for nesting vs selectors.  
-Planning for media queries in CSS (i.e. place after selectors, or make new section?).  
-Establish repeated styling properties earlier and create variables.  
